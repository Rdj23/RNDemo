...
import Heartfiled from '../../resources/icons/Heartfilled.svg'
...
export default function ProductScreen({ navigation, route }) {
  ...
  // ——————————————————————————————————————
  const existingEntry = cartItems.find(item =>
    item.id    === product.id &&
  ...
  const onHeartPress = () => {
    ...
    CleverTap.recordEvent(
      wished ? 'Wishlist Removed' : 'Wishlist Added',
              ...
              <View style={styles.optionsRow}>
                {SIZES.map(sz => {
                  ...
                  return (
                    ...
                    >
                      <Text style={[styles.sizeText, sel && styles.sizeTextSelected]}>
                        {sz}
                      </Text>
                    </TouchableOpacity>
                  );
...
const styles = StyleSheet.create({
  ...
  handle:      {
    width: 40, height: 4,
    backgroundColor: '#EEE', borderRadius: 2,
  ...
  colorCircle: {
    ...
    marginRight: 12, borderWidth: 1, borderColor: '#FFF',
  },
  colorCircleSelected: {
    borderColor: '#30241F', borderWidth: 2,
  },
  ...
  sizeCircleSelected: {
    borderColor: '#30241F', backgroundColor: '#30241F',
  },
  ...
  cartButton: {
    ...
    paddingVertical: 16, borderRadius: 30, margin: 16,
  },
  cartButtonText: { color: '#FFF', fontSize: 16, fontWeight: '600', marginLeft: 8 },
});
